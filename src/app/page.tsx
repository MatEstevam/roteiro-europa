...
const DESTINATIONS = [
  { name: "Paris", country: "França", description: "A cidade luz espera por você" },
  { name: "Roma", country: "Itália", description: "Onde a história ganha vida" },
  { name: "Lisboa", country: "Portugal", description: "Charme à beira do Atlântico" },
  { name: "Barcelona", country: "Espanha", description: "Arte, praia e cultura vibrante" },
  { name: "Amsterdam", country: "Holanda", description: "Canais, museus e liberdade" },
  { name: "Praga", country: "Rep. Tcheca", description: "A cidade dos cem campanários" },
];

const STATS = [
  { value: "50+", label: "Cidades mapeadas" },
  { value: "500+", label: "Atrações turísticas" },
    ...
    <div className="flex flex-col flex-1">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-lg text-white/80 leading-relaxed max-w-xl">
              Crie roteiros personalizados, descubra atrações incríveis e encontre as melhores passagens.
              Tudo de forma simples, visual e pensado para famílias brasileiras.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link
                ...
                className={cn(
                  ...
                  "text-lg px-8 py-7 bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-black font-semibold shadow-xl shadow-orange-500/25 border-0"
                )}
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              ...
              <span className="text-orange-500"> brilhar</span>
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Das ruas de Paris às praias de Lisboa, criamos roteiros para os destinos mais desejados da Europa
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {DESTINATIONS.map((dest) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 to-indigo-600/10 group-hover:from-orange-500/10 group-hover:to-amber-500/10 transition-all duration-500" />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Sem complicação. Você responde, a gente monta.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description: "Em segundos, um roteiro completo com atrações, horários, custos e dicas práticas.",
                icon: "🗺️",
              },
              {
                step: "3",
                title: "Viaje tranquilo",
                description: "Salve, compartilhe com a família e adapte conforme quiser. A viagem é sua.",
                icon: "🌟",
              },
            ].map((item) => (
      ...
      <section className="px-6 py-20 bg-white">
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-2">
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
            <CardContent className="p-8 md:p-10">
              ...
              <p className="text-blue-100 leading-relaxed mb-6">
                Nosso algoritmo distribui os dias de forma equilibrada, respeita seu ritmo e organiza as atrações por proximidade. Com horários, custos e dicas de reserva.
              </p>
              <Link
                href="/planejar"
                className={cn(
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-orange-500 to-amber-600 text-white">
            <CardContent className="p-8 md:p-10">
              <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/20 backdrop-blur-sm mb-6">
              ...
              <p className="text-orange-100 leading-relaxed mb-6">
                Compare preços entre aeroportos, veja qual tem o melhor custo-benefício e descubra se vale a pena sair de outra cidade. Tudo transparente.
              </p>
              <Link
                href="/passagens"
                className={cn(
                  buttonVariants({ size: "lg" }),
                  "bg-white text-orange-700 hover:bg-orange-50 font-semibold"
                )}
              >
                Pesquisar voos
                <ChevronRight className="ml-2 h-4 w-4" />
      ...
      <section className="px-6 py-16 bg-zinc-50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <blockquote className="text-xl italic text-zinc-700 leading-relaxed">
            &ldquo;Nunca tinha viajado para a Europa e não sabia por onde começar.
            Em 5 minutos já tinha um roteiro completo com tudo que precisava saber.&rdquo;
          </blockquote>
          <p className="mt-4 text-sm text-muted-foreground">— Família planejando a primeira viagem</p>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-800 text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-4 text-lg text-blue-200">
            É grátis, rápido e não precisa criar conta para começar.
          </p>
          <Link
            href="/planejar"
            className={cn(
              buttonVariants({ size: "lg" }),
              "mt-8 text-lg px-10 py-7 bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-black font-semibold shadow-xl shadow-orange-500/25 border-0"
            )}
          >
      ...
      <footer className="border-t px-6 py-8 text-center text-sm text-muted-foreground bg-white">
        <p>
          ...
          Os preços e disponibilidades são estimativas e podem variar.
        </p>
      </footer>
    </div>
  );
